...
export const themes: {
...
}[] = [
  {
    name: "default",
    label: "Teal Dream",
    preview: ["#2DD4BF", "#FFF7ED", "#FBBF24"],
    icon: "sparkles",
  },
  {
    name: "ocean",
    label: "Ocean Adventure",
    preview: ["#3B82F6", "#DBEAFE", "#06B6D4"],
    icon: "waves",
  },
  {
    name: "forest",
    label: "Forest Friends",
    preview: ["#22C55E", "#DCFCE7", "#84CC16"],
    icon: "trees",
  },
  {
    name: "candy",
    label: "Candy Land",
    preview: ["#EC4899", "#FDF2F8", "#A855F7"],
    icon: "candy",
  },
  {
    name: "space",
    label: "Space Explorer",
    preview: ["#8B5CF6", "#1E1B4B", "#F472B6"],
    icon: "rocket",
  },
  {
    name: "sunset",
    label: "Sunset Safari",
    preview: ["#F97316", "#FFF7ED", "#EF4444"],
    icon: "sun",
  },
  {
    name: "arctic",
    label: "Arctic Chill",
    preview: ["#06B6D4", "#F0F9FF", "#0EA5E9"],
    icon: "snowflake",
  },
];
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  const setTheme = (newTheme: ThemeName) => {
    ...
    localStorage.setItem("eatutori-theme", newTheme);
