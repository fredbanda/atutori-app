...
import { Calculator, BookOpen, Microscope, Palette, Music, ChevronRight, Sparkles, LogOut, User } from "lucide-react"
...
import { XPBadge } from "@/components/atutori/xp-badge"
import { ProgressRing } from "@/components/atutori/progress-ring"
import { SubjectCard } from "@/components/atutori/subject-card"
...
const quizData = {
  math: [
    { id: 1, question: "If a pizza is cut into 8 slices and you eat 3, what fraction did you eat?", options: ["1/8", "3/8", "8/3", "5/8"], correctAnswer: 1 },
    { id: 2, question: "In 5/6, what does 6 represent?", options: ["Parts you have", "Parts the whole is divided into", "The total", "The answer"], correctAnswer: 1 },
    { id: 3, question: "Which fraction shows half?", options: ["1/4", "1/3", "1/2", "2/4"], correctAnswer: 2 },
    { id: 4, question: "Share 12 cookies with 3 friends equally - what fraction each?", options: ["3/12", "4/12", "12/3", "1/3"], correctAnswer: 1 },
    { id: 5, question: "What is the top number of a fraction called?", options: ["Denominator", "Numerator", "Whole number", "Factor"], correctAnswer: 1 }
  ],
  english: [
    { id: 1, question: "What does reading comprehension mean?", options: ["Reading fast", "Understanding what you read", "Reading aloud", "Memorizing"], correctAnswer: 1 },
    { id: 2, question: "What should you picture when reading?", options: ["Count words", "A movie in your mind", "Skip hard parts", "Read backwards"], correctAnswer: 1 },
    { id: 3, question: "What is NOT a good question while reading?", options: ["Who are the characters?", "Where does it happen?", "What's for dinner?", "What's the problem?"], correctAnswer: 2 },
    { id: 4, question: "How can you tell you understood?", options: ["Read fast", "Explain in your words", "Book is closed", "Finished chapter"], correctAnswer: 1 },
    { id: 5, question: "Good readers always:", options: ["Skip pages", "Think about what they read", "Eyes closed", "Look at pictures only"], correctAnswer: 1 }
  ],
  science: [
    { id: 1, question: "What is the water cycle?", options: ["A bicycle", "Water moving in a circle", "A bottle", "A pool"], correctAnswer: 1 },
    { id: 2, question: "What happens in evaporation?", options: ["Water freezes", "Water becomes vapor", "Clouds form", "It rains"], correctAnswer: 1 },
    { id: 3, question: "What makes water evaporate?", options: ["Moon", "Sun", "Wind", "Fish"], correctAnswer: 1 },
    { id: 4, question: "Rain/snow falling is called:", options: ["Evaporation", "Condensation", "Precipitation", "Celebration"], correctAnswer: 2 },
    { id: 5, question: "What forms when vapor rises?", options: ["Rainbows", "Clouds", "Stars", "Mountains"], correctAnswer: 1 }
  ],
  art: [
    { id: 1, question: "What are primary colors?", options: ["Red, green, blue", "Red, yellow, blue", "Orange, green, purple", "Black, white, gray"], correctAnswer: 1 },
    { id: 2, question: "Red + yellow =", options: ["Green", "Purple", "Orange", "Brown"], correctAnswer: 2 },
    { id: 3, question: "Why are primary colors special?", options: ["Brightest", "Can't mix to make them", "Oldest", "On rainbow"], correctAnswer: 1 },
    { id: 4, question: "Blue + yellow =", options: ["Orange", "Purple", "Green", "Red"], correctAnswer: 2 },
    { id: 5, question: "Orange, green, purple are:", options: ["Primary", "Secondary", "Tertiary", "Rainbow"], correctAnswer: 1 }
  ],
  music: [
    { id: 1, question: "What is rhythm?", options: ["Song words", "Sound/silence patterns", "Song name", "Volume"], correctAnswer: 1 },
    { id: 2, question: "What is a beat?", options: ["A drum", "Steady pulse you feel", "A dance", "Song's end"], correctAnswer: 1 },
    { id: 3, question: "What makes you tap your foot?", options: ["Singer", "Rhythm", "Title", "Instruments"], correctAnswer: 1 },
    { id: 4, question: "What else has rhythm?", options: ["Shadow", "Heartbeat", "Shoes", "Book"], correctAnswer: 1 },
    { id: 5, question: "In music, beats are:", options: ["Strong and soft", "All same", "Only loud", "Only quiet"], correctAnswer: 0 }
  ]
}

const subjectNames: Record<string, string> = {
  math: "Math", english: "English", science: "Science", art: "Art", music: "Music"
}
...
export function DashboardClient({ user }: DashboardClientProps) {
  ...
  const totalProgress = Math.round(subjects.reduce((acc, s) => acc + s.progress, 0) / subjects.length)
  ...
  const handleNextLesson = () => {
    ...
    const nextIndex = (subjectKeys.indexOf(currentSubject) + 1) % subjectKeys.length
        ...
        <section className="mt-8">
          ...
          <Card className="rounded-2xl">
            <CardContent className="divide-y divide-border p-0">
              <ActivityItem subject="Math" lesson="Understanding Fractions" score={4} total={5} time="2 hours ago" color="oklch(0.65 0.18 175)" />
              <ActivityItem subject="English" lesson="Reading Comprehension" score={5} total={5} time="Yesterday" color="oklch(0.75 0.15 280)" />
              <ActivityItem subject="Science" lesson="The Water Cycle" score={3} total={5} time="2 days ago" color="oklch(0.7 0.18 145)" />
            </CardContent>
          </Card>
        </section>
      </main>
...
function ActivityItem({ subject, lesson, score, total, time, color }: {
  subject: string; lesson: string; score: number; total: number; time: string; color: string
}) {
  return (
